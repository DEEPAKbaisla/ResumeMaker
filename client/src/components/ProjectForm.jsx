import { LaptopMinimalCheck, Plus, ProjectorIcon, Trash2 } from "lucide-react";
    ...
    <div>
      ...
      {data.length === 0 ? (
        <div className="text-center py-8 text-gray-500">
          <LaptopMinimalCheck className="w-12 h-12 mx-auto mb-3 text-gray-300" />
          ...
          {data.map((project, index) => {
            return (
              <div
                ...
                <div className="grid md:grid gap-3">
                  <input
                    value={project.name || ""}
                    onChange={(e) =>
