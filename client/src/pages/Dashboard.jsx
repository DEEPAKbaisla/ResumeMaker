...
const Dashboard = () => {
  ...
  const createResume = async (event) => {
    ...
    try {
      ...
      // ✅ Use data.resume instead of resume (resume is undefined here)
      setAllResumes([...allResumes, data.resume]);
      setTitle("");
      setShowCreateResume(false);

      // ✅ Navigate to new resume by its id
  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        <p className="text-2xl font-medium mb-6 bg-gragi"> hey {user.name} </p>
            ...
            <form
              ...
              <div
                ...
                <input
                  ...
                  required
                />
                <button className="w-full py-2 bg-green-600 text-white rounded hover:bg-green transition-color">
                  Create Resume
                </button>
                <XIcon
          ...
          {showUploadResume && (
            <form
              ...
              <div
                ...
                <button disabled={isLoading} className="w-full py-2 bg-green-600 text-white rounded hover:bg-green transition-color">
                  {isLoading && (
